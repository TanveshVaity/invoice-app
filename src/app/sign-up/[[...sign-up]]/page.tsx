      ...
      <SignUp.Root>
        ...
        >
          ...
          <div className="space-y-4">
            <Clerk.Field name="emailAddress" className="space-y-2">
              ...
              <Clerk.Input
                type="text"
                required
                className="w-full rounded-md bg-white px-3.5 py-2 text-sm text-zinc-950 outline-none ring-1 ring-inset ring-zinc-700 hover:ring-zinc-600 focus:bg-transparent focus:ring-[1.5px] focus:ring-blue-400 data-[invalid]:ring-red-400"
              />
          ...
          <p className="text-center text-sm text-zinc-400">
            ...
            <Clerk.Link
              navigate="sign-in"
              className="font-medium text-zinc-950 decoration-white/20 underline-offset-4 outline-none hover:underline focus-visible:underline"
            >
              Sign in
            </Clerk.Link>
          </p>
